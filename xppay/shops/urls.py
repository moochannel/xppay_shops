...
from .views import (
    ...
    ShopCreate, ShopDetail, ShopList, ShopPaying, ShopPdf, ShopUpdate, StaffAccept, StaffDelete,
    StaffInvite, StaffList
)
...
urlpatterns = [
    ...
    path('<slug>/paying/', ShopPaying.as_view(), name='shop_paying'),
